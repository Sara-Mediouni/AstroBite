...
const MobileMenu = ({ isOpen, onClose }) => {
  return (
    <div
      className={`fixed top-0 left-0 w-full h-full z-40 py-10 bg-black/90 text-yellow-300 transform ${
    ...
    >
      <div className="flex justify-between mt-13 items-center p-6 border-b">
        ...
        <button onClick={onClose} className="text-yellow-500 text-2xl font-bold hover:scale-110 right-0">×</button>
