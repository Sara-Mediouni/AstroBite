...
export default function Hero() {
  return (
    <section className="relative h-screen  text-white overflow-hidden flex items-center justify-center px-6">
      ...
      <img
        src={assets.coke}
        className="absolute w-20 top-[15%] left-[10%] animate-float-medium"
      />
      <img
        src={assets.pizza}
        className="absolute w-20 bottom-[20%] right-[15%] animate-float-slow"
      />
      <img
        src={assets.fries}
        className="absolute w-20 top-[25%] right-[25%] animate-float-medium"
      />
